...
const PropertySearchForm = () => {
  ...
  return (
    ...
    >
      ...
      <button
        type='submit'
        className='md:ml-4 mt-4 md:mt-0 w-full md:w-auto px-6 py-3 rounded-lg bg-rose-500 text-white hover:bg-rose-800 focus:outline-none focus:ring focus:ring-rose-900'
      >
        Search
      </button>
    </form>
